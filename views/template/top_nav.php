  ...
  <div class="nav_menu">
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown" role="presentation"><a class="dropdown-toggle info-number" href="javascript:;" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-envelope-o"></i><span class="badge bg-green">6</span></a>
          <ul
