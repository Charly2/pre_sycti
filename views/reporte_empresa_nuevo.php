...
<div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte Empresarial<small></small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            ...
            <div id="wizard_verticle" class="form_wizard wizard_verticle">
              ...
              <div id="step-11" style="margin-bottom: 1em">
                <h2 class="StepTitle">Datos de la Empresa</h2>
                  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback no-margin" style="padding-top: .5em;">
                    <label style="text-align:left" class="control-label">Empresa</label>
              ...
              <div id="step-44">
                ...
                <div style="margin-bottom:0" class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback no-margin">
                  <label style="text-align:left" class="control-label">Fecha de Incio</label>
                  <input type="text" class="form-control has-feedback-right" id="single_cal3" placeholder="First Name" aria-describedby="inputSuccess2Status3" name="inicio">
                ...
                <div style="margin-bottom:0" class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback no-margin">
                  ...
                  <input id="single_cal4" name="entrega" type="text" placeholder="" aria-describedby="inputSuccess2Status4" class="form-control has-feedback-right">
                  <span aria-hidden="true" class="fa fa-calendar form-control-feedback right"></span>
                </div>
                <div style="margin-bottom:0" class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback no-margin">
